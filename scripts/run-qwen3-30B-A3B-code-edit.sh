...
CKPT_ARGS=(
   --hf-checkpoint /mnt/local/hf_cache/hub/Qwen3-30B-A3B
   --ref-load /mnt/local/hf_cache/hub/Qwen3-30B-A3B_torch_dist
   --load /mnt/local/hf_cache/hub/Qwen3-30B-A3B_slime/
   --save /mnt/local/hf_cache/hub/Qwen3-30B-A3B_slime/
   --save-interval 20
)
...
WANDB_ARGS=(
   ...
   --wandb-group qwen3-30B-A3B-code-edit
   --wandb-key ${WANDB_KEY}
)
